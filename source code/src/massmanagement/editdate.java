...
import java.sql.*;
import javax.swing.*;
public class editdate extends javax.swing.JFrame {
                Connection con = null;
                ResultSet rs=null;
...
public final void loadcombobox(){
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
            try{
                ...
                String sql="update bazardate set bday='"+date.getText()+"' where border_name='"+n.toString()+"' and bmonth='"+m.toString()+"'and byear='"+y.toString()+"' " ;
                Class.forName("org.apache.derby.jdbc.EmbeddedDriver");
                con=DriverManager.getConnection("jdbc:derby:millmanage;create=true","app","");
                Statement st=con.createStatement();
                int count=st.executeUpdate(sql);
                if(count>0){
                JOptionPane.showMessageDialog(this,"Bazar Date Successfully Updated");
                }else{
                JOptionPane.showMessageDialog(this,"Check Date and Month carefully");
                }
               con.close();
               st.close();
                 name.setSelectedIndex(0);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(editdate.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
